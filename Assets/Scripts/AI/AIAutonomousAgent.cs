...
public class AIAutonomousAgent : AIAgent
{
    ...
    private void Update()
    {
        ...
        //movement.Acceleration = new Vector3(movement.Acceleration.x, 0, movement.Acceleration.z); // Takes more space for new vector, needs optimization


        // wrap position in world
        //transform.position = Utilities.Wrap(transform.position, new Vector3(-22, -1, -22), new Vector3(22, 10, 22));
    }
